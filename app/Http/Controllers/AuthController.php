        ...
        if (Auth::attempt($infologin)) {
            if (Auth::user()->role === 'user') {
                ...
                if (Auth::user()->email_verified_at != null) {
                    ...
                    Auth::logout();
                    return redirect()->route('login')->with('error_logged_in','Akun Belum Aktif');
            ...
            return redirect()->route('login')->with('error_logged_in','Email atau Sandi anda belum terdaftar');
